...
const LandingPage = () => {
  ...
  return (
    <>
      <div className="bg-[#f3e6cf] min-h-screen flex flex-col items-center justify-center px-6">
        {/* Header */}
        <header className="absolute top-6 left-6 right-6 flex justify-between items-center">
          ...
          <div className="flex gap-4">
            ...
            <button className="px-4 py-2 bg-orange-500 text-white-1 text-sm rounded-full hover:bg-orange-600">
              Sign up
            </button>
          </div>
        </header>
        ...
        <main className="text-center">
          ...
          <h2 className="text-[100px] font-bold text-gray-900 leading-tight">
            All the services
            <br />
          ...
          <button className="mt-6 px-6 py-3 bg-orange-500 text-white-1 text-lg rounded-full hover:bg-orange-600">
            Get the App
          </button>
        </main>
      </div>
